function ShareButtons(selector) {    
    ...
    function openShareWindow(e){
        ...
        var shareImage = "pic.twitter.com/XXXXX";
        var sharePNG = "http://interactive.guim.co.uk/2015/07/the-ashes/imgs/au.jpg";

        var pageMessage = "#Ashes2015 interactive: A history of the Ashes"+ " " + 
                pageUrl + " " + shareImage;
